...
fmax <- read.csv("collman15v2_Fmax_20171214.csv")
sfmax <- scale(fmax, center = TRUE, scale = TRUE)

loc <- read.csv("locations_collman15v2_Fmax_20171214.csv")
```
...
## pairhex
```{r pairnex, fig.height = 8, fig.width = 8, echo=FALSE}
...
set.seed(1030)
h2 <- hmc(sfmax, maxDepth = 2, modelNames = 'VVE')
...
## False Negatives [(synaptograms here)](http://cis.jhu.edu/~jesse/TRA/Collman/collman15v2/GabaFN/)
```{r tFN, echo = FALSE}
kable(lFN, format = 'markdown', escape = FALSE)
```

## False Positives [(some synaptograms here)](http://cis.jhu.edu/~jesse/TRA/Collman/collman15v2/GabaFP/)
```{r tFP, echo = FALSE}

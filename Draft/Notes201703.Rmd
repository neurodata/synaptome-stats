...
```{r stack, echo = FALSE, fig.width = 12, fig.height = 10}
p1 <- p.stackM(hmck1, centered = TRUE, ccol = ccol3, maxDepth = 5) + 
  ggtitle("K15 with 1,000 sample points")
p2 <- p.stackM(hmck2, centered = TRUE, ccol = ccol3, maxDepth = 5) +
  ggtitle("K15 with 1,000 sample points")
p3 <- p.stackM(hmcK3, centered = TRUE, ccol = ccol3, maxDepth = 5) +
  ggtitle("K15 with 10,000 sample points")
p4 <- p.stackM(hmcK4, centered = TRUE, ccol = ccol3, maxDepth = 5) +
  ggtitle("K15 with 10,000 sample points")

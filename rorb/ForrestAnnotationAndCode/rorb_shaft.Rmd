...
p <- ggplot(df1, aes(x = microm3, y = PSD95, color = shaft)) +
...
p2 + geom_density(aes(x = PSD95, y = ..density.., col = as.factor(shaft))) + 
  ggtitle("PSD95 | shaft")

p2 + geom_density(aes(x = microm3, y = ..density.., col = as.factor(shaft))) + 
  ggtitle("size | shaft")

p2 + geom_density(aes(x = microm3, y = ..density.., col = as.factor(shaft))) + scale_x_log10() + 
  ggtitle("size | shaft, x-axis on log10 scale")


p2 + geom_violin(aes(x = as.factor(shaft), y = PSD95)) + geom_jitter(aes(x = as.factor(shaft), y = PSD95), alpha = 0.7)
p2 + geom_violin(aes(x = as.factor(shaft), y = microm3)) + geom_jitter(aes(x = as.factor(shaft), y = microm3), alpha = 0.7)

p2 + geom_boxplot(aes(x = as.factor(shaft), y = PSD95), notch = TRUE)
p2 + geom_boxplot(aes(x = as.factor(shaft), y = microm3), notch = TRUE)
```

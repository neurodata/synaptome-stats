...
```{r cc-msp}
exMat <- cmatfs[exType == 'ex',] -> v1
inMat <- cmatfs[exType == 'in',] -> v2
otMat <- cmatfs[exType == 'other',] -> v3
...
```{r cc-heatV123,eval=TRUE,w=6,h=6,fig.cap=fig$cap("heatV123", "Heatmaps of v1, v2, v3" )}
heatmap.2(as.matrix(v1[, newFord]),dendrogram='none',
          Colv=NA,trace="none", 
...
heatmap.2(as.matrix(v2[, newFord]),dendrogram='none',
          Colv=NA,trace="none", 
          col=mycol,colCol=ccol3[ford][newFord],
          cexRow=0.8, keysize=1.25,
          symkey=FALSE,symbreaks=FALSE,
...
heatmap.2(as.matrix(v3[, newFord]),dendrogram='none',
          Colv=NA,trace="none", 
          col=mycol,colCol=ccol3[ford][newFord],
          cexRow=0.8, keysize=1.25,
          symkey=FALSE,symbreaks=FALSE,
...
```{r cc-heatR1R2, eval=TRUE,w=6,h=6,fig.cap=fig$cap("heatR1R2", "Heatmap of r1 and r2." )}
...
print(ggplot(mdm1, aes(x = XI, y = 0, label=rownames(mdm1))) +
  ...
  geom_text(color = ccol3[ford], check_overlap=TRUE,
            position='jitter'))
```

...
```{r cc-heatG123,eval=TRUE, results='hold',w=6,h=6,fig.cap=fig$cap("heatg123", "Heatmaps of groups Ex, In, Ot" )}
...
```{r cc-heatV123,eval=TRUE, results='hold',w=6,h=4,fig.cap=fig$cap("heatV123", "Heatmaps of v1, v2, v3" )}

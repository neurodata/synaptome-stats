...
```{r cc-syn,w=9,h=6,fig.cap=fig$cap("Syn1v2","Scatter plots of Synap1F0 and Synap2F0 on linear and log scale.)")}
...
```{r cc-vglut,w=9,h=6,fig.cap=fig$cap("Vglut1v2","Scatter plots of VGlut1_t1F0 and VGlut1_t2F0 on linear and log scale.)")}
...
```{r cc-s1vs2F1,w=9,h=6,fig.cap=fig$cap("synF1","Scatter plots of  on linear and log scale.)")}
...
```{r cc-s1vs2F2,w=9,h=6,fig.cap=fig$cap("synF2","Scatter plots of Synapsin1 and Synapsin2 on linear and log scale.)")}
...
```{r cc-s1vs2F3,w=9,h=6,fig.cap=fig$cap("synF3","Scatter plots of Synapsin1 and Synapsin2 on linear and log scale.)")}
...
```{r cc-s1vs2F4,w=9,h=6,fig.cap=fig$cap("synF4","Scatter plots of Synapsin1 and Synapsin2 on linear and log scale.)")}
...
```{r cc-s1vs2F5,w=9,h=6,fig.cap=fig$cap("synF5","Scatter plots of Synapsin1 and Synapsin2 on linear and log scale.)")}
...
```{r cc-F1-5,w=8.5,h=17,fig.cap=fig$cap("synF1-5","Scatter plots of Synapsin1 and Synapsin2 on linear and log scale.)")}

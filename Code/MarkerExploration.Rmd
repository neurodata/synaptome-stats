...
```{r cc-pca2,h=7,w=7,fig.cap=fig$cap("pairs2","PCA of untransformed correlation matrix")}
...
<FONT COLOR=#750000> 
LDA was run using only the first 2 principal 
...
table(truth, pred)
(lda.err <- sum(as.numeric(truth) != as.numeric(pred))/length(truth))
```

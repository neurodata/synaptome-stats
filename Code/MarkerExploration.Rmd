...
```{r shared-sig,h=7,w=7,fig.cap=fig$cap("sh-sig","Shared significances")}
...
A blue $a_{ij}$ element in the above matrix plot implies 
that the null hypothesis that markers $i$ and $j$ are 
independant was rejected at signficance level 0.01.

...
```{r cc-gg3, w=18,h=12, fig.cap=fig$cap("ariPerm","ARI Permutation Tests")}
...
```{r pvals, eval=TRUE,w=12,h=8}
gg5 <- ggplot(data=arid,aes(x=Embedding_Dimension,y=ARI,label=pval)) + 

...
```{r cc_kde1-2, eval=TRUE, cache=TRUE,w=8,h=4,fig.cap=fig$cap("f0kde1-2","Kernel density estimates for each channel, on scaled data.")}
...
fs11 <- fs[kvecfs[[2]]$cluster==1,]
fs12 <- fs[kvecfs[[2]]$cluster==2,]

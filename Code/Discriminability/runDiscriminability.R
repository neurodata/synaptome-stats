...
source("https://raw.githubusercontent.com/neurodata/discriminability/jlp-speedfix/Code/FlashRupdated/functions/reliability.R")
require(meda)
require(raster)
...
relRaw <- rdf(rank_distRaw, as.character(rawLab))
relLog <- rdf(rank_distLog, as.character(logLab))
rel01e3 <- rdf(rank_dist01e3, as.character(e3Lab))
